                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav bookmark-icons">
                            ...
                            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/addfriend" data-toggle="tooltip" data-placement="top" title="Addfriend"><i class="ficon feather icon-user-plus"></i></a></li>
                            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/calenderuser" data-toggle="tooltip" data-placement="top" title="Calendar"><i class="ficon feather icon-calendar"></i></a></li>
                        </ul>
                        <ul class="nav navbar-nav">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="admin">
                    <img src="https://tse4.mm.bing.net/th?id=OIP.L_K3JNiDnQ_uHEnRt3GDkwHaC9&pid=Api&P=0&w=396&h=159" alt="png" width="180px" height="50px">
